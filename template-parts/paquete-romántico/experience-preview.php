...
<section class="l-experience display-desktop">
    <div class="l-experience__content">
        <div class="m-experience-img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/Fotos_experiencias/EXPERIENCIA_6.jpeg);">
    ...
    <div class="m-experience-info">
        ...
        <p class="m-txt--blue m-txt--m">Conoce estás experiencias que tenemos diseñadas especialmente para ti.</p>
...
<section class="l-experience display-tablet">
    ...
    <div class="m-experience-info">
        <div class="m-experience-info__left">
            <h2>Paquete Romántico</h2>
            <p class="m-txt--m">Conoce estás experiencias que tenemos diseñadas especialmente para ti.</p>
        </div>
